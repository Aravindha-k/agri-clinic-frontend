...
export function normalizeTrackingEmployee(emp) {
  ...
  return {
    ...
    last_location_at: emp.last_location_at ?? emp.last_seen ?? emp.last_location?.recorded_at,
    last_location_age_minutes:
      emp.last_location_age_minutes != null ? Number(emp.last_location_age_minutes) : undefined,
    workday_status: emp.workday_status,
    gps_data_status: emp.gps_data_status,
    tracking_task_status: emp.tracking_task_status ?? emp.tracking_status,
    permission_status: emp.permission_status,
    total_points: emp.total_points != null ? Number(emp.total_points) : undefined,
    distance_km: emp.distance_km ?? emp.today_distance_km,
    today_distance_km: emp.today_distance_km ?? emp.distance_km,
    speed: emp.speed,
    accuracy: emp.accuracy,
    battery_level: emp.battery_level,
